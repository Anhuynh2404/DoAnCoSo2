...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" rel="stylesheet" href="{{ asset('admin/assets/css/corporate-ui-dashboard.css?v=1.0.0') }}">
...
<body class="">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8" style="background-image:url('{{ asset('admin/img/login_image.jpg') }}')">
                  <div class="blur mt-12 p-4 text-center border border-white border-radius-md position-absolute fixed-bottom m-4">
                    <h2 class="mt-3 text-dark font-weight-bold">Quản lý thư viện - LibSoft.</h2>
                    <h6 class="text-dark text-sm mt-5">An Huỳnh</h6>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>{{ asset('admin/assets/js/core/popper.min.js') }}</script>
  <script>{{ asset('admin/assets/js/core/bootstrap.min.js') }}</script>
  <script>{{ asset('admin/assets/js/plugins/perfect-scrollbar.min.js') }}</script>
  <script>{{ asset('admin/assets/js/plugins/smooth-scrollbar.min.js') }}</script>
  <script>
