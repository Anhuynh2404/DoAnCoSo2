        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('user.*') ? 'active' : '' }} {{ request()->routeIs('role.*') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Hệ Thống</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('books.*') ? 'active' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Ấn phẩm</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " data-bs-toggle="collapse" href="#collapseExample2" role="button"
                    ...
                    <span class="nav-link-text ms-1">Quản lý mượn trả</span>
                </a>
                    ...
                    <ol class="navbar-nav">
                        ...
                        <li class="nav-item border-start my-0 pt-2">
                            <a class="nav-link position-relative ms-0 ps-2 py-2 " href="../pages/sign-in.html">
                                <span class="nav-link-text ms-1">Phiếu trả</span>
                            </a>
                        </li>
                    </ol>
                </div>
