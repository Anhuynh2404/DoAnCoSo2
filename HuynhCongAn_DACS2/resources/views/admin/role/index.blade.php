        ...
        <div class="card-header border-bottom pb-0">
          <div class="d-sm-flex align-items-center">
            ...
            <div class="ms-auto d-flex">
              ...
              <a href ={{route('role.create')}} type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                    ...
                    <tr>
                        ...
                        <td>
                           <div class="d-flex mt-2">
                            <div>
                                <a href="{{route('role.edit',$role->id)}}" type="button" class="btn btn-dark btn-icon px-3">
                                ...
                                <div class="px-2">
                                    <form action="{{route('role.destroy',$role->id)}}" method="post" id="form-delete{{$role->id}}">
                                        @csrf
                                        @method('DELETE')
