    ...
    <div class="card-body px-0 py-0">
        <form action="{{route('role.update',$role->id)}}" method="post">
            ...
            <div class="form-group px-4 mt-3">
                ...
                <input class="form-control" value="{{old('name') ?? $role->name}}" type="text"  id="example-text-input" name="name">
            ...
            <div class="form-group px-4 ">
                ...
                <input class="form-control" value="{{old('display_name') ?? $role->display_name}}" type="text"  id="example-text-input" name="display_name">
            ...
            <div class="form-group px-4">
              ...
              <select class="form-control" id="exampleFormControlSelect1" name="group" value="{{old('group') ?? $role->group}}">
                        ...
                        <div class ="col-4  px-5">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="{{$item->id}}"   name ="permission_ids[]"  {{$role->permissions->contains('name',$item->name) ? 'checked' : ''}}>
