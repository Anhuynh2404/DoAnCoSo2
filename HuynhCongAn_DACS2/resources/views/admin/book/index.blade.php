    ...
    <div class="card-header border-bottom pb-0">
      <div class="d-sm-flex align-items-center">
        ...
        <div class="ms-auto d-flex">
          ...
          <a href="{{route('books.create')}}" type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="d-flex mt-2">
                            <div>
                                <a href="{{route('books.edit',$book->id)}}" type="button" class="btn btn-dark btn-icon px-3">
