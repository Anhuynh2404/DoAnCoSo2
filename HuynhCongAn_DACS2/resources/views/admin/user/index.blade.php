                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="d-flex mt-2">
                            <div>
                                <a href="{{route('users.edit',$user->id)}}" type="button" class="btn btn-info btn-icon px-3">
                               ...
                               <div class="px-2">
                                <form action="{{route('users.destroy',$user->id)}}" method="post" id="form-delete{{$user->id}}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger btn-icon px-3 btn-delete"  data-id="{{$user->id}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
